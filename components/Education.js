    ...
    <div className='my-64'>
      ...
      <div ref={ref} className='w-[75%] mx-auto relative lg:w-[90%] md:w-full'>
        ...
        <ul className='w-full flex flex-col items-start justify-between ml-4 xs:ml-2'>
            ...
            <Details type='Engineering Degree | Information and Communication Technologies' duration='2021 - 2024' place="Higher Shcool of Communication of Tunis | SUP'COM" info='Focus on Networking Basics and Cybersecurity Fundamentals.'/>
