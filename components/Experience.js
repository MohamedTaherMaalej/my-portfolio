...
Collaborating on security audits and compliance assessments to ensure adherence to industry standards.'/> */}
          <Details  position='Cyber Security Engineer' company='SFR Business' companyLink='https://www.sfrbusiness.fr' duration='May - October 2025' address='Paris, France' work='Designed and implemented an automated vulnerability detection and remediation solution for large-scale Customer Premises Equipment (CPE) environments, securing over 250,000 production devices. Architected a distributed multi-server infrastructure to support scalable vulnerability scanning, remediation workflows, and continuous monitoring. Developed a fully automated end-to-end pipeline, significantly reducing manual intervention and achieving a 100× reduction in remediation time compared to previous processes.
          
          Implemented real-time security dashboards to track key performance indicators, vulnerability status, and remediation progress, enabling improved visibility and faster decision-making for security and operations teams. Hardened Linux-based servers, secured inter-service communications, and deployed real-time monitoring to ensure system resilience and operational stability in production environments.
          
          Collaborated closely with Security, Network, and Operations teams to support production deployment, operational handover, and long-term maintainability. Ensured the solution aligned with regulatory and security requirements, strengthening compliance with NIS2, DORA, CRA, and GDPR. The platform is now fully deployed in production and actively used for vulnerability management, recognized for its operational impact, stability, and innovative automation approach.'/>
